...
class GoldLabel:
        ...
        def get_goldlabel(self, topic_name, date_list=[]):
            ...
            root_path = os.path.join(self.DATA_PATH, topic_name, self.OUTPUT_PATH)
            ...
            for root, directories, files in os.walk(root_path):
                for filename in files:
                    ...
                    self.update_fromonefile(file_path, date_list)
        ...
        def update_fromonefile(self, file_path, date_list):
