...
class DateExtraction:
    ...
    def create_metadata(self):
        ...
        for directory in self.topic_list:
                ...
                if  not (os.path.isfile(metadata_path + '\\' + directory + 'date_list.txt') & os.path.isfile(metadata_path + '\\' + directory + 'feature_vector_list.txt')):
                    ...
                    output = open(metadata_path + '\\' + directory + 'feature_vector_list.txt', 'wb')
                ...
                if not os.path.isfile(metadata_path + '\\' + directory + 'gold_label.txt'):
                    ...
                    gold_label = output_var.get_goldlabel(directory)
    ...
    def get_data(self):
        ...
        for directory in self.topic_list:
            ...
            input1 = open('{0}\\{1}feature_vector_list.txt'.format(root_path, directory), 'rb')
    ...
    def test_classifier(self):
        ...
        print "Accuracy Score", metrics.accuracy_score(self.gold_label, predict_vector)
